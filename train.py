...
'''
172, 229, 175, 171, 50,  73
71,  137, 145, 190,  27, 124
'''
...
def main(config_file):
    ...
    for epoch in range(options.num_epochs):
        ...
        # Train
        print('teacher_forcing', options.teacher_forcing_ratio if epoch >= options.teacher_forcing_epoch else 1.0)
        train_result = run_epoch(
            ...
            optimizer,
            lr_scheduler,
            options.teacher_forcing_ratio if epoch >= options.teacher_forcing_epoch else 1.0, # train일때만 teacher_forcing_ratio 작동
