...
def main(parser):
    ...
    '''
    root: 이미지 경로 루트
        file_path(default): /opt/ml/input/data/eval_dataset/input.txt
    data: gt.txt 같은 거, file_name 과 latex 2개 컬럼 존재
    test_data의 컬럼: 1.경로, 2.파일명, 3.더미_gt
